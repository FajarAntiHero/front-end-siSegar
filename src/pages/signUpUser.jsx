            ...
            <div className="w-full h-[100vh] px-6 bg-parsley-200 flex justify-center items-center">
                <div className="w-full h-fit">
                    <div className="w-full h-fit rounded-3xl bg-parsley-50 mb-3 p-4">
                        ...
                        <div className="w-full h-fit">
                            <p className="font-montserrat font-bold text-parsley-600 text-center text-[20px] mb-4">Buat Akun</p>
                            <div className="w-full h-fit">
                                <form action="" className="flex flex-col items-center">
                                    ...
                                    <InputComponent nameLabel={"Konfirmasi Kata Sandi"} idForm={"password"} typeInput={"password"} placeholder={"Kata Sandi Akun"} marginForm={"mb-6"} bgInput={"bg-parsley-200"} isRequired={true}/>
                                    <ButtonComponent 
