...
function Hero(){
    ...
    const cardHero = useScrollAnimation({})
        ...
        <div className="w-full h-[90vh] bg-parsley-50">
            <div className="w-full md:w-[75%] md:mx-auto px-6 h-full flex flex-col lg:flex-row justify-evenly lg:items-center">
                <div className="w-full lg:w-[40%] h-fit mt-4 mb-[2rem] ">
                    <p className="font-montserrat text-parsley-950 font-bold text-[28px] md:text-[32px] mb-[1rem]">siSegar Peduli Lingkungan Hijau dan Peduli Alam</p>
                ...
                <div className="w-full lg:w-[40%] h-fit bg-parsley-300 rounded-2xl p-2" ref={cardHero}>
