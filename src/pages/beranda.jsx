        ...
        <div className="w-full h-[90vh] bg-parsley-50">
            <div className="container p-5 h-full flex flex-col">
                <div className="w-full h-fit mt-4 mb-[2rem]">
                    ...
                    <a href="" className="inline-flex items-center justify-center rounded-2xl font-montserrat font-bold text-parsley-950 w-[55%] h-[50px] bg-parsley-400 ">Informasi Lengkap</a>
                </div>
