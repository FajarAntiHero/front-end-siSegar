    ...
    <footer>
      <div className="bg-parsley-50 flex flex-col items-center font-montserrat">
        ...
        <div className="flex items-center gap-2 m-[1vh]">
          <img src={logo_sisegar} alt="Logo siSegar" className="w-[4vh] h-[4vh] rounded-full" />
        ...
        <div className="m-[1vh] flex flex-col items-center">
          <p className="text-[16px] font-bold text-parsley-950">Sosial Media siSegar</p>
          <div className="flex items-center gap-2 m-[1vh]">
            {socialIcons.map((icon) => (
              ...
              >
                <i className={`fa-brands fa-${icon} text-parsley-950 text-[2.2vh] leading-none`} />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-parsley-300 w-full flex justify-center items-center">
          <div className="m-[2vh] gap-5">
            <div className="flex items-center gap-25 m-[1vh]">
              <p className="text-[12px] text-center text-parsley-950">All Rights Reserved</p>
              <p className="text-[12px] text-center text-parsley-950">Privacy Policy</p>
            </div>
            <p className="text-[12px] text-center text-parsley-950">@CopyRights siSegar 2025</p>
          </div>
        </div>
      </div>
    </footer>
